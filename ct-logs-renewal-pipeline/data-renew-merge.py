...
Syncs certificate documents from `data-renew.certificates` into the main
`certificates` collection used by the dashboard. data-renew is always
...
def sync():
    ...
    log("INFO", f"{total_remaining} document(s) left to sync from data-renew.")
