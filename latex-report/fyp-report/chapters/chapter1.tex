...
security research, operational monitoring, and informed assessment. Although the
platform supports global analysis, it places a special focus on Pakistan's
certificate landscape: \texttt{.pk} domains were extracted from multiple global
datasets and merged into the primary collection, enabling Pakistan-specific
country-level analytical scopes alongside the global view.
