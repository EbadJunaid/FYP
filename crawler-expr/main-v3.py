...
CONFIG = {
    ...
    'DB_NAME': "hugging-face-domains",
    'STATUS_COLLECTION': "domain_status",
    'CERTIFICATES_COLLECTION': "certificates",
    
    # Paths
    'CSV_FILE': os.path.join(BASE_DIR, ".\hugging-face-domains-data\chunk-5million.csv"),
    'ZCERT_BINARY': os.path.join(BASE_DIR, "./zcertificate/zcertificate.exe"),
    'LOG_FILE': os.path.join(BASE_DIR,"hugging-face-04-jun-26.log"),
    'ISSUE_LOG_FILE': os.path.join(BASE_DIR,"hugging-face-04-jun-26-threads-fareeze.txt"),
    'NUM_THREADS': 30,
    'SOCKET_TIMEOUT': 10,
    'ZCERT_TIMEOUT': 10,
    'RETRY_ENABLED': False,
