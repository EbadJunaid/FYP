### This is legacy crawler because it add's raw field into each certificates  
### It does not add scope field 
### This is the crawler which runs on VM and gather most of our data
### Currently we don't use this because we need scope and raw field 
